                ...
                >
                  <div className="w-[150px] h-[240px] sm:w-[200px] sm:h-[300px] md:w-[250px] md:h-[350px] lg:w-[300px] rounded-lg overflow-hidden shadow-lg">
                    ...
                    >
                      ...
                      <button className="relative z-10 mx-auto mt-auto flex items-center gap-1 rounded-full bg-white py-1 px-3 text-[10px] sm:text-xs text-black shadow-md hover:bg-gray-100">
                        Book Now
