export const CarouselItems = [
  {
    ...
    description:
      "Professional detailing services for all aircraft types, from single-engine Cessnas to Gulfstreams. Includes wet washes, boot conditioning, and brightwork polishing.",
...
export const positions = [
  ...
  { x: "-75%", z: 10, scale: 0.85, opacity: 1 }, // Left
];
